...
def main():
    ...
    # step for training textual embedding
    text_train_step = 4000 
    # step for fine-tuning u-net model, is also not necessary 
    model_train_step = 1000 
